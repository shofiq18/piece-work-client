...
const Footer = ({ user }) => {
    return (
        <div className="bg-black text-white p-10">
            <footer className="footer max-w-7xl mx-auto text-neutral-content p-10">
                <aside>
                    <p>
                        <span className="text-green-600 text-3xl font-bold">PieceWork</span>
                        <br />
                ...
                <nav>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link to="/user-profile" className="hover:opacity-80">User Profile</Link>
                        </li>
                    </ul>
                </nav>
                ...
                <nav>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="hover:opacity-80 bg-blue-700 p-2 rounded-full"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="hover:opacity-80 bg-gray-900 p-2 rounded-full"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="hover:opacity-80 bg-blue-600 p-2 rounded-full"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
