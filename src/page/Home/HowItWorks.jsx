...
const HowItWorks = () => {
  return (
    <div>
      <section className="bg-gradient-to-r from-blue-400 via-purple-800 to-green-400 px-6 py-12">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center px-3">
              ...
              <p className=" px-3">Earn at your own pace by completing simple micro-tasks that fit your schedule.</p>
            </div>
            <div className="flex flex-col items-center">
              ...
              <p className=" px-3">We ensure all tasks are legitimate, so you can work with confidence and security.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" className="text-white">
              ...
              <p className=" px-3">Get paid quickly and securely upon task completion.</p>
            </div>
          </div>
        </div>
      </section>
