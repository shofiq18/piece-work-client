...
const AdminHome = () => {
  ...
  return (
    <div className="p-4">
      <div className="max-w-6xl mx-auto mb-12 p-6   rounded-lg shadow-xl ">
        <h1 className="text-2xl font-bold text-center mb-6">Admin Dashboard</h1>

        {/* Stats Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Total Workers */}
          <div className="flex flex-col items-center text-center border p-6 rounded-lg shadow hover:shadow-lg transition">
